...
public partial class Admin_CountryManage : System.Web.UI.Page
{
    ...
    protected void CountryGrid_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "del")
        {
            ...
            mycon();
            cmd = new SqlCommand("delete  CountryTbl where CountryId = @coId", con);
