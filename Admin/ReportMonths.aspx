<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterAdmin.master" AutoEventWireup="true" CodeFile="ReportMonths.aspx.cs" Inherits="Admin_ReportMonths" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentRight" runat="Server">
    <div class="container-fluid" style="margin-top: 8%">
        ...
        <div id="ContentPage_typeAdd" class="d-sm-flex align-items-center justify-content-between mb-4 w-50">
            <asp:TextBox ID="TxtReportMonths" TextMode="Month" runat="server"></asp:TextBox>
             <asp:RequiredFieldValidator ID="reqValue" runat="server"
                ControlToValidate="TxtReportMonths"
                ErrorMessage="Please enter Value"
                ForeColor="Red" Display="Dynamic" />
            <asp:Button ID="BtnReportMonths" OnClick="BtnReportMonths_Click"
                 CssClass="btn btn-primary" runat="server" Text="Search" />
            ...
            <div class="card-body table-responsive">
                <div>
                    <asp:GridView ID="ReportMonthsGridView" runat="server"
