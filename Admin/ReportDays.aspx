<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterAdmin.master" AutoEventWireup="true" CodeFile="ReportDays.aspx.cs" Inherits="Admin_ReportDays" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentRight" runat="Server">
    ...
    <div class="container-fluid" style="margin-top: 8%">
        ...
        <div id="ContentPage_typeAdd" class="d-sm-flex align-items-center justify-content-between mb-4 w-50">
            ...
            <asp:Button ID="BtnReportDays" CssClass="btn btn-primary" runat="server" Text="Search" OnClick="BtnReportDays_Click" />
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body table-responsive">
                <div>
                    <asp:GridView ID="ReportDaysGridView" runat="server"
