<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterAdmin.master" AutoEventWireup="true" CodeFile="ReportYear.aspx.cs" Inherits="Admin_ReportYear" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentRight" runat="Server">
    <div class="container-fluid" style="margin-top: 8%">
        ...
        <div id="ContentPage_typeAdd" class="d-sm-flex align-items-center justify-content-between mb-4 w-50">
            ...
            <asp:DropDownList ID="DropdownReportYear" runat="server"></asp:DropDownList>
